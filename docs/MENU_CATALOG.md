...
- Category, menu, and availability updates require expected `version`. Full admin CRUD, mobile cache/reconnect behavior, and audit guarantees are documented in `MENU_MANAGEMENT_E2E.md` (#132). Complex promotions and inventory remain outside scope.
